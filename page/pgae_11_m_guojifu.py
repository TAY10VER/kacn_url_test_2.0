...
class Page_11(Base):
    ...
    def page_get_all_goods_name(self):
        list = []
        all_goods = self.base_find_items(page.m_guojifu_goods_names)
    ...
    def page_get_all_links(self):
        eles = self.base_find_items(page.m_guojifu_goods_hrefs)
        links = []
    ...
    def page_get_goods_values_list(self, driver):
        items = self.base_find_items(page.m_guojifu_goods_types)
        list = []
